...
# Why can't I make a boolean array and count like: df[df['retention_1']=='True'].count()
...
# Creating an list with bootstrapped means for each AB-group #Not sure about the code
boot_1d = []
for i in range(500):
